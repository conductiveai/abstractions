...
ens_transactions AS (
    ...
    WHERE
        ...
        ("to" = '0x9062c0a6dbd6108336bcbe4593a3d1ce05512069' OR "to" = '0x084b1c3c81545d370f3634392de611caabff8148')
...
INSERT INTO labels.labels2(address, name, type, author, source)
SELECT 
    t.eth_addr AS address, 
    LOWER(c.ens_name) AS label,
    'ens name reverse' AS type,
    'zxsasha' AS author,
    'ethereum_mainnet_ens_name_reverse' AS source
