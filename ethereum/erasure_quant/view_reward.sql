...
WHERE "from" IN ('\x0000000000377D181A0ebd08590c6B399b272000'::bytea,
                 '\xdc6997b078C709327649443D0765BCAa8e37aA6C'::bytea,
                 '\x67b18F10C0Ff8C76e28a383B404E8e6FDEfe2050'::bytea)
  AND "to" IN
