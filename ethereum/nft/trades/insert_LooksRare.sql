...
WITH looks_rare AS (
    SELECT 
        ...
        CASE -- REPLACE `ETH` WITH `WETH` for ERC20 lookup later
            WHEN currency = '\x0000000000000000000000000000000000000000'::bytea THEN '\xc02aaa39b223fe8d0a0e5c4f27ead9083c756cc2'::bytea
            ELSE currency
...
ROWS AS (
    ...
    SELECT
        ...
        CASE WHEN trades.original_currency_address = '\x0000000000000000000000000000000000000000'::bytea THEN 'ETH' ELSE erc20.symbol END AS original_currency,
