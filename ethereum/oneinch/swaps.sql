...
WITH swap AS (
    SELECT tx."from" AS tx_from,
        tx."to" AS tx_to,
        CASE WHEN from_token = '\x0000000000000000000000000000000000000000'::bytea THEN '\xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee'::bytea ELSE from_token END as from_token,
        CASE WHEN to_token = '\x0000000000000000000000000000000000000000'::bytea THEN '\xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee'::bytea ELSE to_token END as to_token,
        from_amount,
        to_amount,
        tx_hash,
        tmp.evt_index,
        ...
        from_amount * (
            CASE
                WHEN from_token IN (
                    '\x0000000000000000000000000000000000000000'::bytea, -- ETH
