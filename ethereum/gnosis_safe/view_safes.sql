...
CREATE MATERIALIZED VIEW gnosis_safe.view_safes AS
    ...
    WHERE et.success = True
        ...
        AND (
            (substring(et."input" for 4) = '\x0ec78d9e'::bytea -- setup methods of v0.1.0
                AND et."to" = '\x8942595A2dC5181Df0465AF0D7be08c8f23C93af'::bytea) -- mastercopy v0.1.0
            OR
            (substring(et."input" for 4) = '\xa97ab18a' -- setup methods of v1.0.0
                AND et."to" = '\xb6029ea3b2c51d09a50b53ca8012feeb05bda35a'::bytea) -- mastercopy v1.0.0
            OR
            (substring(et."input" for 4) = '\xb63e800d'::bytea -- setup methods of v1.1.0, v1.1.1, 1.2.0
            AND et."to" IN (
                '\xae32496491b53841efb51829d6f886387708f99b'::bytea,  -- mastercopy v1.1.0
                '\x34cfac646f301356faa8b21e94227e3583fe3f5f'::bytea,  -- mastercopy v1.1.1
                '\x6851d6fdfafd08c0295c392436245e5bc78b0185'::bytea)  -- mastercopy v1.2.0
            )
        )
